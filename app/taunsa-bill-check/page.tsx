...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.mepcoonlinebill.net/taunsa-bill-check",
  },
  keywords: [
    "MEPCO Taunsa bill",
    "Taunsa bill check",
    ...
    "@graph": [
      {
        ...
        "@id": "https://www.mepcoonlinebill.net/taunsa-bill-check#service",
      ...
      {
        "@type": "HowTo",
        "@id": "https://www.mepcoonlinebill.net/taunsa-bill-check#howto",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.mepcoonlinebill.net/taunsa-bill-check#faq",
        mainEntity: [
          {
            "@type": "Question",
