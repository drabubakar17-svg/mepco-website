...
export const metadata: Metadata = {
  title: `MEPCO Layyah Bill Check Online ${currentYear} | Duplicate Bill`,
  description:
  ...
  alternates: {
    canonical: "https://www.mepcoonlinebill.net/layyah-bill-check",
  },
  keywords: [
    "MEPCO Layyah bill",
    "Layyah bill check",
    "MEPCO duplicate bill Layyah",
    "online electricity bill Layyah",
    "Karor Lal Esan MEPCO bill",
    "Chowk Azam electricity bill",
    "Fatehpur MEPCO bill",
  ],
};

export default function LayyahBillCheckPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "GovernmentService",
        "@id": "https://www.mepcoonlinebill.net/layyah-bill-check#service",
        ...
        "areaServed": [
          { "@type": "AdministrativeArea", "name": "Layyah" },
          { "@type": "AdministrativeArea", "name": "Karor Lal Esan" },
          { "@type": "AdministrativeArea", "name": "Chowk Azam" },
          { "@type": "AdministrativeArea", "name": "Fatehpur" }
        ]
      },
      {
        "@type": "FAQPage",
        "@id": "https://www.mepcoonlinebill.net/layyah-bill-check#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How can I check my Layyah MEPCO bill online?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "You can check your MEPCO Layyah electricity bill online using your 14-digit reference number or customer ID."
            }
          },
          {
            "@type": "Question",
            "name": "Can I check my Layyah bill without a paper bill?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, if you have your 14-digit reference number or customer ID handy from any old invoice, you can instantly look up your latest MEPCO electricity bill online."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, a printed copy of your duplicate electricity bill fetched online is completely valid for payments at commercial bank branches, post offices, and omni-banking applications."
            }
          }
        ]
      }
  ...
  const cities = [
    { name: "MEPCO Dera Ghazi Khan Bill Check", href: "/dera-ghazi-khan-bill-check" },
        ...
        <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:py-16">
          <nav aria-label="Breadcrumb" className="mb-4">
            <p className="text-xs font-bold uppercase tracking-wider text-green-700">
              ...
              <span className="mx-1 text-slate-400">&gt;</span> Layyah
            </p>
          </nav>

          <header className="mb-10">
            <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl md:text-5xl">
              MEPCO Layyah Bill Check Online {currentYear}
            </h1>

            <p className="mt-4 text-lg leading-relaxed text-slate-600">
              Layyah electricity consumers can check their MEPCO bill online
              using a 14-digit reference number or customer ID. This page helps
              users view, download, and print duplicate MEPCO bills quickly.
            </p>
          </header>
          ...
          <section className="mb-10 rounded-2xl border border-green-200 bg-white p-6 shadow-sm sm:p-8">
            <h2 className="mb-4 text-xl font-bold text-slate-950 sm:text-2xl">
              How to Check Layyah MEPCO Bill
            </h2>
            ...
            <ol className="space-y-3 text-slate-600 list-decimal pl-5">
              ...
              <li className="pl-1">
                Enter the reference number in the calculation or tracking field above.
              </li>
              <li className="pl-1">
          ...
          <div className="space-y-8 text-slate-700 leading-relaxed">
            <section>
              <h2 className="mb-3 text-2xl font-bold text-slate-900">
                Duplicate Electricity Bill for Layyah
              </h2>
              <p>
                If your printed electricity bill is lost, delayed, or damaged,
                you can access your MEPCO Layyah duplicate bill online. It helps
                you check due date, payable amount, consumed units, taxes,
            ...
            <section>
              <h2 className="mb-3 text-2xl font-bold text-slate-900">
                Areas Covered under Layyah Region
              </h2>
              <p>
                MEPCO serves electricity consumers across{" "}
                <strong className="text-slate-900">Layyah</strong>,{" "}
                <strong className="text-slate-900">Karor Lal Esan</strong>,{" "}
                <strong className="text-slate-900">Chowk Azam</strong>,{" "}
                <strong className="text-slate-900">Fatehpur</strong>, and nearby
              ...
              >
                <summary className="flex cursor-pointer items-center justify-between gap-1.5 text-slate-900 focus:outline-none">
                  <h3 className="text-lg font-semibold">
                    Can I check my Layyah bill without a paper bill?
                  </h3>
